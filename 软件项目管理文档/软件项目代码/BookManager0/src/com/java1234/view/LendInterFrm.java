...
import com.java1234.dao.LendDao;
import com.java1234.model.Book;
import com.java1234.model.BookType;
import com.java1234.util.DbUtil;

public class LendInterFrm extends JInternalFrame {
	...
	private void bookTableMousePressed(MouseEvent met) {
	    ...
	    int result = JOptionPane.showConfirmDialog(null, "是否退还此书:"+a);
		if(result ==0) {
			JOptionPane.showMessageDialog(null, a+"退还成功！");
			}
	...
	private void fillTable(Book book){
		...
		try{
			con=dbUtil.getCon();
			ResultSet rs=lendDao.list(con, book);
			while(rs.next()){
				Vector v=new Vector();
